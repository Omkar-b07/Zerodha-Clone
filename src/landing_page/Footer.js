        ...
        <footer style={{backgroundColor:"rgb(250,250,250)"}}>
            <div className='container mt-5'>
                <div className='row mt-5' >
                    <div className='col'>
                        <img src="media/images/logo.svg" className='mt-5' style={{ width: '25%' }} alt="logo" />
                    ...
                    <div className='col' >
                        ...
                        style={{textDecoration:"none"}}>Press & media</a>
                        <br></br>
                    ...
                    <div className='col'style={{textDecoration:"none"}} >
                        <p className='mt-5'>Account</p>
                        <a href=''className='text-muted'style={{textDecoration:"none"}}>Opena an account</a>
                        <br></br>
